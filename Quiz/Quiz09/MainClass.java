...
public class MainClass {
		...
		public static void main(String[] args) {
			 ...
			 */
			User person = new User("홍길동", 123123, 20);
			System.out.println(person.getName());
			System.out.println(person.getRrn());
			 ...
			 */
			User[] arr = new User[2]; //클래스도 타입이 될수 있음
			User person2 = new User("김길동", 456456, 30);
			
			arr[0] = person;
			arr[1] = person2;
			
			for(User result : arr) {
				System.out.println("[" + result.getName() + "," + result.getRrn() + "," + result.getAge() + "]");
			...
			while(i < arr2.length) {
				...
				User person3 = new User(name, rrn, age);
